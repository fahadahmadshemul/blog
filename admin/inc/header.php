...
?>
<!--for delete cache use this code-->
<?php
    header("Cache-Control: no-cache, must-revalidate");
    header("Pragma: no-cache");
    header("Expire: Sat, 26 Jul 1997 05:00:00 GMT");
        ...
        <div class="grid_12 header-repeat">
            <div id="branding">
				...
				<div class="floatleft middle">
					<h1>Fahad Ahmad Shemul</h1>
					<p>www.facebook.com/fahadahmad.shemul</p>
				</div>
...
?>
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class="ic-dashboard"><a href="theme.php"><span>Theam</span></a> </li>
